...
# is_running_app = [is_running(app) for app in THIRD_PARTY_APPS_LIST_COSTOME]
# print(is_running_app)
...
def print_data():
    while True:
        ...
        #         if(not is_running(all_packages[p].package_data_dict['PACKAGE_NAME'])):
        #             run.append(p)
        #             print(p)
        #     for p in run:
        #         all_packages.pop(p, None)
        ...
        for pid in all:
            ...
            # if(is_running(all[pid].package_data_dict['PACKAGE_NAME'])):
